...
$(function() {
    ...
    // function cardHeaderActive (){
    //   cardBody.each(function(){
    //     // console.log($(this).hasClass('show'))
    //     if($(this).hasClass('show') == true){
    //       var thisParent = $(this).parent();
    //       // console.log(thisParent)
    //       thisParent.find('.card-header').addClass("active").end().siblings().find(".card-header").removeClass('active')
    //     }
    //   })
    // }
    // cardHeaderActive ()
    ...
    tabCard.on('click',function(){
      $(this).each(function(){
        ...
        $(this).siblings().find('.card-header').removeClass('active')
      })
        // thisParent.find('.card-header').addClass("active").end().siblings().find(".card-header").removeClass('active');
    })
    ...
    //===== Show Popup Messege
    var showPopup = $('#showPopupMSG').data('showpopup');
    if (showPopup == true){
      $('#agarthaModal').modal('show')
    }
    $("body").on('change', '#showPopupMSG', function() {
      if ($(this).val() == "true"){
        $('#agarthaModal').modal('show')
